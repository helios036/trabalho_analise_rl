...
set.seed(0038) # Define a seed para garantir que o resultado seja o mesmo se rodar novamente
n_amostra = 300 # Tamanho da amostra

indices_amostra <- sample(1:nrow(database), size = n_amostra, replace = FALSE)
